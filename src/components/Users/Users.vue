<template>
  <div>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-tooltip effect="dark" content="分配角色" placement="top-start" :enterable="false">
              <el-button type="warning" icon="el-icon-setting" @click="setUser(scope.row)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
    ...
    <!-- 分配角色对话框 -->
    <el-dialog title="分配角色" :visible.sync="setUserDialogVisible"
     width="40%" @close="rolelistClose" >
      <!-- 主体内容 -->
      <div>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="setNewUser">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
